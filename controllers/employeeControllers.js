const Employees = require("../models/Employees"); //module users
const Courses = require("../models/Courses"); //module users
let studentCourses = require("../models/studentCourse");
...
//   phoneNumber: req.body.phoneNumbers,
//   type: "User",
//   companyName: "RR",
//   password,
// };
// const ans = await User.findOne({
//   where: { userName: registerUser.name },
// });
// // const ans2 = await User.findOne({ where: { email: registerUser.email } }); || ans2
// if (ans) {
//   return res.status(200).json({ error: "userName  already registered " });
// }
// let id2 = uuidv4();
// //create new token
// const token = createToken(registerUser.name);
// await User.create({ id2, ...registerUser, token }); //register new user
